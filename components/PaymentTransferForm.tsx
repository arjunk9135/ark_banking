              ...
              <div className="payment-transfer_form-item pb-6 pt-5">
                ...
                <div className="flex w-full flex-col">
                  <FormControl>
                    <BankDropdown
                      accounts={accounts}
                      setValue={(value: any) => field.onChange(value)} // Pass the entire bank object
                      selectedValue={accounts.find((account: any) => account.appwriteItemId === field.value) || null} // Bind the selected account object to the form
                      otherStyles="!w-full"
                    />
                  </FormControl>
